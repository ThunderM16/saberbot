...
I'm currently being run and developed by .💻Storm M#0001 (676195747904880690) but the bot is open source (<https://github.com/ezywebca/yagpdb>), so if you know Go and want to make some contributions, feel free to make a PR.
